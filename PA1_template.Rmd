...
median_steps
```
The mean total number of steps per day is `r mean_steps`. The median total number of steps per day is `r median_steps`.
...
max_int
```
The interval with the maximum number of steps, on average, is interval `r max_int`, which corresponds to minute `r mon_data$interval[104]`.
...
The mean number of steps per day with the imputed data is `r mean_steps2-mean_steps` steps more than without the imputed data.  
The median number of steps per day with the with the imputed data is `r median_steps2-median_steps` steps more than without the imputed data.  
